 ...
 *  Is the same date?
 *
 *  @param hyb_anotherDate The another date to compare as NSDate
 ...
 *  Add days to self
 *
 *  @param hyb_days The number of days to add
 ...
 *
 *  @param hyb_month The month to be converted in string
 *  [1 - January]
 *  [2 - February]
 *  [3 - March]
 *  [4 - April]
