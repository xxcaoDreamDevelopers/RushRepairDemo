...
@interface NewTaskDetailFooter()
@property (nonatomic, strong) UIButton *refuseBtn;
@property (nonatomic, strong) UIButton *acceptBtn;
@end
@implementation NewTaskDetailFooter

-(instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        //1.去这里
        UIButton *goHereBtn = [[UIButton alloc]init];
        goHereBtn.backgroundColor = [Common colorFromHexRGB:@"11c63c"];
        ...
        repairBtn.backgroundColor = [Common colorFromHexRGB:@"f57f0a"];
        [repairBtn setTitle:@"领取工单" forState:UIControlStateNormal];
